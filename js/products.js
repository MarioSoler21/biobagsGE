...
const PRODUCTS = [
  {
    ...
    imageAlt: "Bolsa Bio Bags Básica de carbón activado, color negro, con el logo Biobags",
  ...
  },
  {
    ...
    imageAlt: "Bolsa Bio Bags Plus de cáscara de banano, color café claro, con el logo Biobags",
